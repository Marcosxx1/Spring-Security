...
INSERT IGNORE INTO `users`
VALUES ('admin', '{bcrypt}$2a$12$DTzG57.5qOiRdyQrtelWx.Vu5ySjiC8Nd6b2Hp.IzsMtNVasd6prW', '1');
INSERT IGNORE INTO `authorities`
VALUES ('admin', 'admin');
...
VALUES ('marcos@marcos.com', '{noop}12345', 'read');
insert into `customer` (email, password, role)
VALUES ('admin@admin.com', '{noop}12345', 'read');
