...
public class ErrorMessages {
    ...
    public static final String ERROR_RESOURCE_NOT_FOUND_TITLE = "error.not-found.title";
    public static final String ERROR_RESOURCE_NOT_FOUND_DETAIL = "error.not-found.detail";
